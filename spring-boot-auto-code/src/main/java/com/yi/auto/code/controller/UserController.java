...
import com.yi.auto.code.service.RoleService;
...
public class UserController  {
	...
	@ResponseBody
	public DataRes selectUserAndRole(User user,HttpServletRequest request,HttpServletResponse response){
		return DataRes.success(userService.selectUserAndRole(user));
	}
	 ...
	 * 级联条件查询 用户--班级
	 */
	@RequestMapping("user/selectUserAndRoleByCondition")
	@ResponseBody
	public DataRes selectUserAndRoleByCondition(User user,HttpServletRequest request,HttpServletResponse response){
		return DataRes.success(userService.selectUserAndRoleByCondition(user));
	}
	 ...
	 * 级联删除(根据主键删除) 用户--班级
	 */
	@RequestMapping("user/deleteUserAndRole")
	@ResponseBody
	public DataRes deleteUserAndRole(User user,HttpServletRequest request,HttpServletResponse response){
		return DataRes.success(userService.deleteUserAndRole(user));
	}
	 ...
	 * 根据外表id查询主表表所有数据(带分页)
	 */
	@RequestMapping("user/selectUserByRole")
	@ResponseBody
	public DataRes selectUserByRole(HttpServletRequest request,HttpServletResponse response,User user){
		return DataRes.success(userService.selectUserByRole(user));
	}
